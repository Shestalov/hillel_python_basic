...
@decorator
def login(user_name: str, user_password: str, time_now: str, log: str) -> bool:
    return True


def check_password(user_name: str, user_password: str, log: str) -> bool:
...
def rewrite_logs(file_name: str, data: str):
    try:
...
def registration_name(data: dict) -> str:
    while True:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if asking == "2":
            ...
            logs[new_username] = new_password
